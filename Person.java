...
public abstract class Person implements Active, Adaptable, Comparable<Person> {
	...
	public Person(String name, boolean isMale, int age, int height, int weight, JButton choice) {
		this.name = name;
		this.isMale = isMale;
		this.age = age;
		this.height = height;
...
public Person(String name, int egn, int age, int height, int weight, JButton choice) {
		this.name = name;
		this.egn = egn;
		this.age = age;
		this.height = height;
