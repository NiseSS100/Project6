...
public class Professor extends Person {
	...
	public Professor(String title, String name, boolean isMale, 
					 int age, int height, int weight, JButton choice) {
		super(name, isMale, age, height, weight, choice);
		this.title = title;
	}
	
	public Professor(String name, String title, int egn, int age, int height, int weight, JButton choice) {
		super(name, egn, age, height, weight, choice);
		this.title = title;
	}
	...
	public static class ProfessorGenerator {
		...
		public static Professor make() {
			...
			return new Professor(name, title, egn, age, height, weight, choice);
		}
	}
}
